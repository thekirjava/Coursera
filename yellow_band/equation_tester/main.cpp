...
void TestRoot() {
    AssertEqual(GetDistinctRealRootCount(0, 0, 5), 0, "a = 0, b = 0, c = 5");
    AssertEqual(GetDistinctRealRootCount(0, 5, 0), 1, "a = 0, b = 5, c = 0");
    AssertEqual(GetDistinctRealRootCount(5, 0, 0), 1, "a = 5, b = 0, c = 0");
    ...
    AssertEqual(GetDistinctRealRootCount(2, 2, 2), 0, "a = 2, b = 2, c = 2");
