...
namespace Ast {
    ...
    private:
        ObjectHolder ExecuteChain(Runtime::Closure &closure, size_t index);
    };
    ...
    protected:
        std::optional<ObjectHolder> executeClass(Runtime::ClassInstance *lhs,
    ...
    private:
        std::unique_ptr<Statement> condition_, if_body, else_body;
    };
